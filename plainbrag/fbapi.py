...
class Facebook(object):
	...
	temp = urllib.urlopen(url,payload)
        tempstr = temp.read()
        result = json.loads(tempstr)

#result = json.loads(urlfetch.fetch( url=u'https://' + domain + u'.facebook.com' + path, payload=urllib.urlencode(params), method=urlfetch.POST, headers={ u'Content-Type': u'application/x-www-form-urlencoded'}) .content)
